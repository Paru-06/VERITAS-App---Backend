...
fake = pd.read_csv("Fake.csv").sample(5000, random_state=42)
true = pd.read_csv("True.csv").sample(5000, random_state=42)
ag = pd.read_csv("train.csv").sample(5000, random_state=42)
welfake = pd.read_csv("WELFake_Dataset.csv").sample(5000, random_state=42)

huff = pd.read_json("News_Category_Dataset_v3.json", lines=True).sample(5000, random_state=42)
